...
<!-- 		"One person with a belief is equal to ninety-nine who have only interests." <br>- John Stuart Mill -->
	...
	<div class="row">
		...
		<div class="col-md-8 interest-content">
			<h3>My Cats</h3>
			<p>I don't own any cats or any other "pets."  However, I do care for a family of 9 stray cats, who have taken up residence behind my house.  I used to chase them away, like everyone else did.  But then the Mom cat gave birth to a litter of beauties (the first time), and I've been taking good care of them ever since, like my own. And though I like to tell people that "I just couldn't refuse help to a damsel in distress," I think I just wanted to care for someone.</p>
		</div>
	</div>
	<div class="row" id="technology">
		...
		<div class="col-md-8 interest-content">
			<h3>Technology</h3>
			<p>Sticks are technology.  Fire is technology.  Language is technology.  Government is technology.  Technology is as essential to us as photosynthesis is to green plants, or bird's nests are to birds.  Technology is not something separate or outside of us, but rather it is an extension of life itself.</p>
		</div>
	</div>
	<div class="row">
		<div class="col-md-4 left">
		...
		<div class="col-md-8 interest-content">
			<h3>Exercise</h3>
			<p>At least once or twice a week, you'll find me at the gym or just doing pushups at home.  A strong body makes the mind strong.  Also, feed the intellect and starve the beast, but that's not really here nor there.  "The nation that will insist on drawing a broad line of demarcation between the fighting man and the thinking man is liable to find its fighting done by fools and its thinking done by cowards." --Thucydides </p>
		</div>
	</div>
...
<div id="causes" class="container">
	...
	<div class="row vertical-align" id="wikileaks">
		<div class="col-md-4 left">
			<a target="_blank" href="https://wikileaks.org/">
	...
	<div class="row vertical-align" id="ftff">
		<div class="col-md-4 left">
			<a target="_blank" href="https://www.fightforthefuture.org/">
	...
	<div class="row vertical-align" id="freepress">
		<div class="col-md-4 right">
			<a target="_blank" href="https://www.freepress.net/">
