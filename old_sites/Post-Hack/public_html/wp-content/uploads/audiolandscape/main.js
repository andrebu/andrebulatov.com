require([
    '/wp-content/uploads/audiolandscape/viz.js'
],function(
    viz
){
    'use strict';
    ...
    function launchVapor(){
        viz({
            ...
            skyMap: '/wp-content/uploads/audiolandscape/vapor.png',
            cameraHeight: 10,
            mp3Url: '/wp-content/uploads/audiolandscape/clint-mansell-requiem-for-a-dream-orchestral-version.mp3',
    ...
    function launchVolcano(){
        viz({
            ...
            skyMap: '/wp-content/uploads/audiolandscape/cracks.jpg',
            cameraHeight: 30,
            mp3Url: '/wp-content/uploads/audiolandscape/the-prodigy-mindfields.mp3'
        });
    }
    ...
    function launchHills(){
        viz({
            ...
            skyMap: '/wp-content/uploads/audiolandscape/sky.jpg',
            cameraHeight: 5,
            mp3Url: '/wp-content/uploads/audiolandscape/geoff-muldaur-brazil.mp3'
        });
    }
