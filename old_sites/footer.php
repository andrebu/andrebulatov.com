...
<!-- Left side of sub-footer -->
		<div class="col-md-2 col-sm-6 col-xs-6 subFooter leftOne">
			<a class="btn btn-default btn-xs text-center" id="subFooterEmailLink" href="mailto:moc.votaluberdna@tcatnoc" target="_blank">
				<span class="fa fa-fw fa-envelope"></span> Message Me
			</a>
		</div> 
		...
		<div class="license-info col-md-2 col-sm-6 col-xs-6">
			...
			<span data-toggle="tooltip" data-placement="top"  title="Click for license info" class="license-tooltip-container">
				<a data-toggle="modal" data-target="#licenseModal" class="license-tooltip-trigger">
					<img alt="Creative Commons License" src="/wp-content/uploads/images/creative-commons-license-cc-by-4.png" />
				</a>
			</span>
		</div>
		<!-- License modal -->
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
				<div class="gpl-license">
					<span>Andre's Website</span> 
					by 
					<a href="https://andrebulatov.com" >Andre Bulatov</a> 
					is licensed under a 
					<a rel="license" href="http://creativecommons.org/licenses/by/4.0/">Creative Commons Attribution 4.0 International License</a>
					.
					<br>
					Based on a work at 
					<a href="https://andrebulatov.com">https://andrebulatov.com</a>.
					<br>
					<br>
...
<!-- Copyright copyleft site info  -->
		<div class="site-info col-md-8 col-sm-12 col-xs-12">
			<span class="copyleft">  
				...
				2014  Made by 
				<img id="Andre" src="/wp-content/uploads/images/Andre-tiny.png" alt="Andre Bulatov" width="17" height="17" data-toggle="tooltip" data-placement="top" title="Andre">
				with 
